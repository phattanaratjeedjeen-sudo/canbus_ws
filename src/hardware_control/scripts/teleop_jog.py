...
class TeleopJog(Node):
    def __init__(self):
        ...
        self.positive_keys = {'1': 0, '2': 1, '3': 2, '4': 3, '5': 4, '6': 5}
        self.negative_keys = {'q': 0, 'w': 1, 'e': 2, 'r': 3, 't': 4, 'y': 5}
        self.msg = JointState()
    ...
    def print_help(self):
        self.get_logger().info(
            ...
            "Arrows Up/Down: Change Global Speed Step\n"
            "Press [Enter]: Call /stop service to stop all motors\n"
            "Press [ESC]: Call /reset service to reset all motors\n"
            "Conflict Rule: Pressing forward and backward for the same joint sets it to 0.\n"
            "-------------------------------"
        )
    ...
    def call_reset_service(self):
        ...
        self.get_logger().warn('ESC pressed: Calling /reset service to reset all motors...')
        req = Trigger.Request()
    ...
    def call_stop_service(self):
        ...
        self.get_logger().warn('ENTER pressed: Calling /stop service to stop all motors...')
        req = Trigger.Request()
